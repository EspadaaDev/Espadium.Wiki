...
export function Sidebar({ activeId }: { activeId?: string }) {
  ...
  return (
    <div className="w-[280px] border-r border-border bg-surface h-[calc(100vh-3rem)] overflow-y-auto p-3 text-sm">
      <div className="mb-2 px-2 text-slate-500 uppercase tracking-wide">Spaces</div>
